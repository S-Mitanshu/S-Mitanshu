<h1 align="center">Hi there, I'm Mitanshu 👋</h1>
...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=2F81F7&center=true&vCenter=true&width=600&lines=Building+secure+systems+one+bug+at+a+time...;Currently+arguing+with+a+cryptographic+protocol;Transformer+models+%3E+regex+rules;git+commit+-m+%22it+works%2C+don't+ask+how%22" alt="Typing SVG" />
</p>
...
class Mitanshu:
    def __init__(self):
        ...
        self.education = "B.Tech CSE @ IIIT Pune (2023 - 2027)"
        self.honors = "CyberSecurity Honors — CGPA 10.0/10.0 😤"
        self.currently_exploring = ["Cloud Security", "Applied ML", "Distributed Systems"]
        self.weapons_of_choice = ["C++", "Python", "Java"]
        self.fun_fact = "I once secured a system better than I secure my sleep schedule"

    def say_hi(self):
        return "Let's build something that doesn't fall apart in production 🚀"
...
**☁️ Google Cloud Arcade 2025**
Arcade Novice Tier — a pile of hands-on cloud labs and skill badges that taught me the cloud is just someone else's very well-documented computer.
`GCP` `Cloud Labs`
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=cpp,python,java,c,bash,mysql,sqlite,git,github,docker,aws,linux&theme=dark" />
</p>

**Coursework that actually stuck:** OOPs · DBMS · Operating Systems · Computer Networks · Information Security · Cloud Computing
...
- 🥇 **Top 20 / 300+** in *CodeRed* competitive coding contest (AIT Pune)
- ⚔️ Codeforces max rating **1296** — rated rounds are basically my cardio
- 🌟 CodeChef **3★** coder, 1634 rating, 55+ rated contests survived
- 🧩 Slowly turning LeetCode's problem set into a personal grudge match
- 🎓 **Reliance Foundation Undergraduate Scholarship** recipient
- 📈 Top 25 percentile in a 6-week Data Science & ML program
- 🐛 Certified bug creator, occasional bug fixer
...
<p align="center"><i>"It compiles. Ship it." — me, ignoring three warnings</i></p>

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=S-Mitanshu&label=Profile+Views&color=2F81F7&style=flat" />
</p>